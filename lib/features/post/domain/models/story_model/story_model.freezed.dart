...
abstract class $StoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userImage, String image});
}
...
class _$StoryModelImpl implements _StoryModel {
  _$StoryModelImpl({this.userImage = "", this.image = ""});
  ...
  @override
  String toString() {
    return 'StoryModel(userImage: $userImage, image: $image)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userImage, image);
...
abstract class _StoryModel implements StoryModel {
  factory _StoryModel({final String userImage, final String image}) =
      _$StoryModelImpl;
